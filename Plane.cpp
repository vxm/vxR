...
Color Plane::color() const { return m_color; }

void Plane::setColor(const Color &color) { m_color = color; }

v3s Plane::pointA() const { return m_pointA; }

void Plane::setPointA(const v3s &point1) { m_pointA = point1; }

v3s Plane::pointB() const { return m_pointB; }

void Plane::setPointB(const v3s &point2) { m_pointB = point2; }

v3s Plane::pointC() const { return m_pointC; }

void Plane::setPointC(const v3s &point3) { m_pointC = point3; }

scalar Plane::y() const { return m_y; }

void Plane::setY(scalar y) { m_y = y; }

scalar Plane::z() const { return m_z; }

void Plane::setZ(scalar z) { m_z = z; }

scalar Plane::d() const { return m_d; }

void Plane::setD(scalar d) { m_d = d; }
...
scalar Plane::x() const { return m_x; }

void Plane::setX(scalar x) { m_x = x; }
