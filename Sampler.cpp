...
bool Sampler::isDone() const
{
	return m_iter+1==m_nSamples;
}

scalar Sampler::x() const
{
	return MU::getRand(1.0);
}

scalar Sampler::y() const
{
	return MU::getRand(1.0);
}
...
void Sampler::resetIterator()
{
	m_iter=0;
}

bool Sampler::random() const
{
	return m_random;
}

void Sampler::setRandom(bool random)
{
	m_random = random;
}
