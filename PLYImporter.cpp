...
PLYImporter::PLYImporter(vxTriangleMeshHandle geo)
	:m_geo(geo)
{
}

vxTriangleMeshHandle PLYImporter::getGeometry() const
{
	return m_geo;
}

void PLYImporter::setGeometry(const vxTriangleMeshHandle &geo)
{
	m_geo = geo;
}
