...
TriangleMesh::TriangleMesh() : Geometry() {}

std::vector<TriRef> &TriangleMesh::triangles() { return m_triangles; }

std::vector<v2s> &TriangleMesh::uvs() { return m_uvs; }

std::vector<v2s> TriangleMesh::uvs() const { return m_uvs; }

void TriangleMesh::setUvs(const std::vector<v2s> &uvs) { m_uvs = uvs; }

std::vector<v3s> &TriangleMesh::vertexNormals() { return m_vertexNormals; }

std::vector<v3s> TriangleMesh::vertexNormals() const { return m_vertexNormals; }
...
std::vector<v3s> TriangleMesh::vertices() const { return m_vertices; }

std::vector<v3s> &TriangleMesh::vertices() { return m_vertices; }
...
void TriangleMesh::open() { m_openForEdition = true; }
...
unsigned long TriangleMesh::vertexCount() const { return m_vertices.size(); }

unsigned long TriangleMesh::triangleCount() const { return m_triangles.size(); }
...
unsigned long TriangleMesh::uvsCount() const { return m_uvs.size(); }
